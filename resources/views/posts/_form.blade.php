...
<label class="uppercase text-gray-700 text-xs" for="title">Titulo</label>
...
<textarea name="body" rows="15" class="rounded border-gray-200 w-full mb-4">{{ old('body', @$post->body) }}</textarea>
